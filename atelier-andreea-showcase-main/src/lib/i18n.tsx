  ...
  en: {
    ...
    admin: {
      ...
      exhibitions: {
        ...
        uploadFromPc: "Upload from computer (recommended, compressed)",
        imageUrlOptional: "Or paste a direct image link",
        importUrl: "Import link to storage",
        imageStored: "Saved on site",
      },
    },
  ...
  ro: {
    ...
    admin: {
      ...
      exhibitions: {
        ...
        uploadFromPc: "Încarcă de pe computer (recomandat, comprimat)",
        imageUrlOptional: "Sau lipește un link direct către imagine",
        importUrl: "Importă linkul în storage",
        imageStored: "Salvat pe site",
      },
    },
